...
- Weak: resize is covered at backend, headless, GTK window-event, and split-divider drag levels, but scrollback reflow edge cases are still weak.
...
4. Add deeper allocation/source attribution and scrollback reflow edge coverage.
