...
- Partial: `src/command_blocks.rs` converts semantic-prompt rows from the terminal core into prompt/output block metadata, and `RenderFrame.command_blocks` exports it for renderer/diagnostic consumers.
